...
<div style="display: flex; justify-content: space-between; align-items: center; margin-bottom: 30px;">
    <div>
        <h1 style="font-family: var(--font-outfit); font-weight: 800; font-size: 2rem; color: var(--text-color); margin-bottom: 4px;">Categorias</h1>
        <p style="color: var(--text-muted); font-size: 0.95rem;">Gerencie as categorias de produtos cadastrados.</p>
    </div>
    <a href="/admin/categories/create" style="display: inline-flex; align-items: center; gap: 8px; background-color: var(--accent-purple); color: #ffffff; text-decoration: none; padding: 12px 24px; border-radius: 30px; font-family: var(--font-outfit); font-weight: 600; font-size: 0.9rem; transition: background-color 0.25s ease; border: none; cursor: pointer;" onmouseover="this.style.backgroundColor='var(--accent-purple-hover)'" onmouseout="this.style.backgroundColor='var(--accent-purple)'">

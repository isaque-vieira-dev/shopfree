...
<main class="auth-container">
    <div class="auth-card">
        <div class="auth-header">
            ...
            <p class="auth-subtitle">Crie uma nova senha de acesso segura para a sua conta</p>
        </div>
        ...
        <form action="/reset-password" method="POST" class="auth-form">
            ...
            <button type="submit" class="btn btn-solid btn-block">REDEFINIR SENHA</button>
        </form>

        <div class="auth-footer">
            <p>Lembrou a senha? <a href="/login">Entrar</a></p>
        </div>
    </div>
</main>

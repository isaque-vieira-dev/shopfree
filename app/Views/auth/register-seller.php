...
<main class="auth-container">
    <div class="auth-card">
        <div class="auth-header">
            <h2 class="auth-title">Venda Conosco</h2>
            <p class="auth-subtitle">Cadastre-se como vendedor e comece a anunciar seus produtos hoje</p>
        </div>
        ...
        <form action="/seller" method="POST" class="auth-form">
            <div class="form-group">
                <label for="name">Nome da Loja / Nome Completo</label>
                <div class="input-wrapper">
                    <svg class="input-icon" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2" fill="none" stroke-linecap="round" stroke-linejoin="round"><path d="M20 21v-2a4 4 0 0 0-4-4H8a4 4 0 0 0-4 4v2"></path><circle cx="12" cy="7" r="4"></circle></svg>
                    <input type="text" id="name" name="name" placeholder="Ex: Addina Store ou Seu Nome" required autocomplete="name">
                </div>
            </div>
            ...
            <div class="form-group">
                ...
                <div class="input-wrapper">
                    ...
                    <input type="email" id="email" name="email" placeholder="comercial@exemplo.com" required autocomplete="email">
                </div>
            </div>
            ...
            <button type="submit" class="btn btn-solid btn-block">CRIAR CONTA DE VENDEDOR</button>
        </form>

        <div class="auth-footer">
            <p>Já é um vendedor? <a href="/login">Entrar</a></p>
        </div>
    </div>
</main>
